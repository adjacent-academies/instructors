...
*/
  ...
  function rowSumCalc(inputSquare){
    // Try not to use generic i,j,k variable names - use clear names to explain usage
    // Explain why this isn't good practice but can be useful for understanding what's going on
    let allRowSums = [];
    ...
    // While this is inefficient it matches the approach the student was trying to take so I want 
    // to try to follow their thought process and guide them to a more effective refactor.
    let isMagic = true;
...
/**
  ...
  if rowSum, colSum, and diagSum are all equal AND areRowsMagic, areColsMagic, and areDiagsMagic are all TRUE
